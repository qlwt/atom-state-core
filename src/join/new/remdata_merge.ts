...
export type Join_NewRemDataMerge_Params<
    Param,
    RDef extends RemNode_Def,
    Joins extends Join_NewRemNodeMerge_Joins_G<RDef>
> = Join_NewRemNodeMerge_Params<Param, RDef, Joins>

export const join_new_remdata_merge = function <
    Param,
    RDef extends RemNode_Def,
    Joins extends Join_NewRemNodeMerge_Joins_G<RDef>
>(
    params: Join_NewRemDataMerge_Params<Param, RDef, Joins>
): Join<Param, Join_RemNodeMerge<RDef, Join_NewRemNodeMerge_Joins<RDef, Joins>>["data"]> {
    return join_new_pipeo_data({
        join: join_new_remnode_merge(params),
    })
}

export const join_newf_remdata_merge = function <
    Param,
    RDef extends RemNode_Def,
    Joins extends Join_NewRemNodeMerge_Joins_G<RDef>
>(
    params: Join_NewRemDataMerge_Params<Param, RDef, Joins>
): JoinF<Param, Join_RemNodeMerge<RDef, Join_NewRemNodeMerge_Joins<RDef, Joins>>["data"]> {
    const result = join_new_remdata_merge(params)

    return () => result
}

export const join_news_remdata_merge = function <
    Param,
    RDef extends RemNode_Def,
    Joins extends Join_NewRemNodeMerge_Joins_G<RDef>
>(
    ...
    const result = join_new_remdata_merge({
        link_new,
        joins,
    })
