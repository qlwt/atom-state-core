import type { AtomFamily_Value } from "#src/family/type/AtomFamily.js"
...
export type AtomRemNode_Value<Def extends AtomRemNode_Def> = {
    ...
    readonly real: AtomRemState_Value<Def["data"], Def["request_result"], Def["request_meta"]>

    readonly optimistic: AtomFamily_Value<
        string,
        AtomRemReq_Value<
