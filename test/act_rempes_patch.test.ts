import { act_rempes_patch } from "#src/act/rempes/patch.js";
...
test("act_rempes_patch base", async () => {
...
test("act_rempes_patch deps base", async () => {
    const outputs = new Array<any>()
    const expectations = new Array<any>()
...
test("act_rempes_patch interrupt", async () => {
    const outputs = new Array<any>()
    const expectations = new Array<any>()
